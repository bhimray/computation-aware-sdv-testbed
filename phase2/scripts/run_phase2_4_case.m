...
nominalUtilization = ...
    durationData.mean_s/controlTaskPeriod_s ...
    + communicationTaskExecutionTime_s/communicationTaskPeriod_s ...
    + loadTaskExecutionTime_s/loadTaskPeriod_s;
...
assert(~isempty(runIds), "No Simulation Data Inspector run was created.");

latestRun = Simulink.sdi.getRun(runIds(end));
taskData = socTaskTimes(options.ModelName, latestRun.Name, "SuppressPlot");
