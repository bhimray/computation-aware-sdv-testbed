...
torqueRateSignal = logs.get("torque_rate_opt").Values;
steeringRateSignal = logs.get("steering_rate_opt").Values;
...
results.torque_rate_Nmps = toColumn(torqueRateSignal.Data);
results.torque_rate_time_s = toColumn(torqueRateSignal.Time);
results.steering_rate_radps = toColumn(steeringRateSignal.Data);
results.steering_rate_time_s = toColumn(steeringRateSignal.Time);
...
results.torque_applied_time = ...
    results.torque_applied_time_s;
results.steering_applied_angle_deg = toColumn(steeringAppliedSignal.Data);
